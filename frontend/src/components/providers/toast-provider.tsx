...
export function ToastProvider() {
  return (
    <Toaster
      ...
      toastOptions={{
        classNames: {
          toast: "border border-slate-800 bg-slate-900 shadow-2xl shadow-purple-500/10 backdrop-blur-xl",
          ...
          closeButton: "bg-slate-800 border-slate-700 text-slate-400 hover:bg-slate-700 hover:text-purple-300",
        },
      }}
    />
  );
